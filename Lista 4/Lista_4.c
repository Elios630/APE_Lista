...
int main() {
    ...
    for(i=0;i<5;i++){
        ...
        produto[i].peso=le_valida_peso();

        printf("Informe o valor de compra produto %d: \n", i+1);
        produto[i].valorCompra=le_valida_compra();
            
        printf("Informe o valor de venda produto %d: \n", i+1);
        produto[i].valorVenda=le_valida_venda();
    ...
    do{
        ...
        switch (escolha){
            case 1:
                ...
                printf("Informe o peso produto %d: \n", conProd+1);
                produto[conProd].peso=le_valida_peso();
    ...
    do{
        ...
        printf("- [A] Listar todos os produtos em ordem alfabÃ©tica crescente A-Z\n");
        printf("- [Z] Listar todas as marcas em ordem alfabÃ©tica decrescente Z-A\n");
        ...
        switch (menu){
            ...
            case '1':
                ...
                apresentaFabricante(&fabricante, conFab);
            ...
            case '2':
                ...
                apresentaProduto(&produto, conProd);
            ...
            case '9':
                ...
                ordenaPerLucro(&produto, conProd);
            ...
            case 'A':
                printf("=====================================================================\n");
                printf("   RELATORIO A - PRODUTOS EM ORDEM ALFABÃ‰TICA CRESCENTE (descriÃ§Ã£o)\n");
                printf("=====================================================================\n");
                printf("Descricao\t|\tMarca\t|\tpeso\t|\tV. de compra\t|\tV. de venda\t|\tLucro\t\t|\tPer. de lucro\n");

                ordenaProduto(&produto, conProd);
                apresentaProduto(&produto, conProd);
                printf("\n");
                do{
                    printf("- [0] Voltar para tela principal\n");
            ...
            case 'Z':
                printf("=====================================================================\n");
                printf("          RELATORIO Z - MARCAS EM ORDEM ALFABÃ‰TICA DECRESCENTE\n");
                printf("=====================================================================\n");
                printf("Marca\t|\tSite\t\t|\tTelefone\t|\tUF\n");
                
                ordenaFabricante(&fabricante, conFab);
                apresentaFabricante(&fabricante, conFab);
...
void apresentaProduto(Produto* produto, int conProd){
	int i = 0;
    printf("------------------------+---------------+---------------+-----------------------+-----------------------+---------------+-------------------------\n");
	for(i=0;i<conProd;i++){
		printf("%s\t|\t%s\t|\t%d\t|\t%f\t|\t%f\t|\t%f\t|\t%f\n", produto[i].descricao, produto[i].fabricante.marca, produto[i].peso, produto[i].valorCompra, produto[i].valorVenda, produto[i].valorLucro, produto[i].percenLucro);
...
void ordenaProduto(Produto* produto, int conProd){
	int i=0, j=0;
	
	Produto aux;
	
	for(i=0;i<conProd;i++){
		for(j=i+1;j<conProd;j++){
			if(strcmp(produto[i].descricao,produto[j].descricao)>0){
				aux = produto[i];
				produto[i] = produto[j];
				produto[j] = aux;	
			}
...
void apresentaFabricante(Fabricante* fabricante, int conFab){
    char uf[2], bufferUF[2];
	int i=0, j=0;
   for (i = 0; i < conFab; i++){
        bufferUF[0] = '\0';
        for (j = 0; j < 2; j++){
...
void ordenaFabricante(Fabricante* fabricante, int conFab){
	int i=0, j=0;
	
	Fabricante aux;
	
	for(i=0;i<conFab;i++){
		for(j=i+1;j<conFab;j++){
			if(strcmp(fabricante[j].marca,fabricante[i].marca)>0){
				aux = fabricante[i];
				fabricante[i] = fabricante[j];
				fabricante[j] = aux;	
			}
		}
	}	
...
void ordenaVenda(Produto* produto, int conProd){
	int i=0, j=0;
...
void ordenaLucro(Produto* produto, int conProd){
	int i=0, j=0;
...
void ordenaPerLucro(Produto* produto, int conProd){
	int i=0, j=0;
...
int main() {
    ...
    do{
        ...
        switch (menu){
            ...
            case 'A':
                printf("=====================================================================\n");
                printf("   RELATORIO A - PRODUTOS EM ORDEM ALFABÉTICA CRESCENTE (descrição)\n");
                printf("=====================================================================\n");
                printf("Descricao\t|\tMarca\t|\tpeso\t|\tV. de compra\t|\tV. de venda\t|\tLucro\t\t|\tPer. de lucro\n");
            ...
            case 'Z':
                printf("=====================================================================\n");
                printf("          RELATORIO Z - MARCAS EM ORDEM ALFABÉTICA DECRESCENTE\n");
                printf("=====================================================================\n");
                printf("Marca\t|\tSite\t\t|\tTelefone\t|\tUF\n");
